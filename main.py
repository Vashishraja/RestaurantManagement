...
def system():
    ...
    # Top part
    main_lbl = Label(topframe, font=('Calibri', 30, 'bold'), text="Restaurant Management System", fg="black",bg="lightyellow",
                   anchor=W)
    main_lbl.grid(row=0, column=3)
    main_lbl = Label(topframe, font=('Calibri', 15,), text=localtime, fg="black",bg="lightyellow", anchor=W)
    main_lbl.grid(row=2, column=3)

    ### Labels
    # items
    ordlbl = Label(leftframe, font=('Calibri', 16, 'bold'), text="Order No.",bg="lightyellow", fg="black", bd=5, anchor=W).grid(row=1,
                                                                                                             column=0)
    ordtxt = Entry(leftframe, font=('Calibri', 16, 'bold'), bd=6, insertwidth=4, justify='right',
                   textvariable=orderno).grid(row=1, column=1)
    # Pizza
    pizlbl = Label(leftframe, font=('Calibri', 16, 'bold'), text="Pizza",bg="lightyellow", fg="black", bd=5, anchor=W).grid(row=2,
                                                                                                         column=0)
    piztxt = Entry(leftframe, font=('Calibri', 16, 'bold'), bd=6, insertwidth=4, justify='right',
                   textvariable=pizza).grid(row=2, column=1)
    # burger
    burlbl = Label(leftframe, font=('Calibri', 16, 'bold'), text="Burger",bg="lightyellow", fg="black", bd=5, anchor=W).grid(row=3,
                                                                                                          column=0)
    burtxt = Entry(leftframe, font=('Calibri', 16, 'bold'), bd=6, insertwidth=4, justify='right',
                   textvariable=burger).grid(row=3, column=1)

    # icecream
    icelbl = Label(leftframe, font=('Calibri', 16, 'bold'), text="Ice Cream",bg="lightyellow", fg="black", bd=5, anchor=W).grid(row=4,
                                                                                                             column=0)
    icetxt = Entry(leftframe, font=('Calibri', 16, 'bold'), bd=6, insertwidth=4, justify='right',
                   textvariable=icecream).grid(row=4, column=1)
    # drinks
    drinklbl = Label(leftframe, font=('Calibri', 16, 'bold'), text="Drinks",bg="lightyellow", fg="black", bd=5, anchor=W).grid(row=5,
                                                                                                            column=0)
    drinktxt = Entry(leftframe, font=('Calibri', 16, 'bold'), bd=6, insertwidth=4, justify='right',
                     textvariable=drinks).grid(row=5, column=1)
    # cost
    costlbl = Label(leftframe, font=('Calibri', 16, 'bold'), text="Cost",bg="lightyellow", bd=5, anchor=W).grid(row=6, column=0)
    costtxt = Entry(leftframe, font=('Calibri', 16, 'bold'), bd=6, insertwidth=4, justify='right',
                    textvariable=cost).grid(row=6, column=1)
    # subtotal
    sublbl = Label(leftframe, font=('Calibri', 16, 'bold'), text="Subtotal",bg="lightyellow", bd=5, anchor=W).grid(row=7, column=0)
    subtxt = Entry(leftframe, font=('Calibri', 16, 'bold'), bd=6, insertwidth=4, justify='right',
                   textvariable=subtotal).grid(row=7, column=1)
    # tax
    taxlbl = Label(leftframe, font=('Calibri', 16, 'bold'), text="Tax",bg="lightyellow", bd=5, anchor=W).grid(row=8, column=0)
    taxtxt = Entry(leftframe, font=('Calibri', 16, 'bold'), bd=6, insertwidth=4, justify='right',
                   textvariable=tax).grid(row=8, column=1)
    # service
    servicelbl = Label(leftframe, font=('Calibri', 16, 'bold'), text="Service",bg="lightyellow", bd=5, anchor=W).grid(row=9,
                                                                                                              column=0)
    servicetxt = Entry(leftframe, font=('Calibri', 16, 'bold'), bd=6, insertwidth=4, justify='right',
                       textvariable=service).grid(row=9, column=1)
    # total
    totallbl = Label(leftframe, font=('Calibri', 16, 'bold'), text="Total",bg="lightyellow", bd=5, anchor=W).grid(row=10,
                                                                                                          column=0)
    ...
    totbtn = Button(leftframe, font=('Calibri', 15, 'bold'), text="Total", bg="yellow", fg="black", bd=3, padx=4, pady=4,
                    width=10, command=tottal).grid(row=4, column=3)

    resetbtn = Button(leftframe, font=('Calibri', 15, 'bold'), text="Reset", bg="yellow", fg="black", bd=3, padx=4,
                      pady=4, width=10, command=reset).grid(row=6, column=2)

    exitbtn = Button(bottomframe, font=('Calibri', 15, 'bold'), text=" Exit ", bg="yellow", fg="red", bd=3, padx=4,
                     pady=4, width=10, command=exit).grid(row=10, column=2)

    addbtn = Button(leftframe, font=('Calibri', 15, 'bold'), text="Add", bg="yellow", fg="black", bd=3, padx=4, pady=4,
                    width=10, command=add).grid(row=4, column=2)

    deletebtn = Button(leftframe, font=('Calibri', 15, 'bold'), text="Delete", bg="yellow", fg="black", bd=3,
    ...
    # Feedbackbutton
    feedbtn = Button(menuframe, font=('Calibri', 15, 'bold'), text="Feedback Form", fg="darkblue", bg="yellow", bd=3, padx=6,
    ...
    # menubutton
    menubtn = Button(menuframe, font=('Calibri', 15, 'bold'), text="Menu Card", bg="yellow", fg="darkblue", bd=3, padx=6,
